...
module.exports = {
  ...
  devServer: {
    ...
    before(app) {
      // 商城-香奈儿店铺数据
      app
        .get("/mall/chanel", (req, res, next) => {
          res.json(chanelMsg);
        })
        .get("/mall/goodsInfo", (req, res, next) => {
          res.json(goodsInfo);
        })
        .get("/modal/goodsInfo", (req, res, next) => {
          res.json(goodsInfoModal);
        })
        .get("/modal/goodsCard", (req, res, next) => {
          res.json(goodsCardModal);
        });
    },
  },
};
